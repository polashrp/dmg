...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:Hrp@2017@localhost/dmg?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:Hrp@2017@localhost:3306/dmg?new_link=true');
  }
}
...
$civicrm_root = '/var/www/html/dmg/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/html/dmg/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://127.0.0.1/dmg/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '96873e3b8a3f5350187741f0a6e4ce2b');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/html/dmg/sites/default/files/civicrm/templates_c//mail.log');
// }
