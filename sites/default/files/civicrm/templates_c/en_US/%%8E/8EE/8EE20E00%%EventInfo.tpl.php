...
">
  ...
  <?php if ($this->_tpl_vars['isShowLocation']): ?>
      ...
      <?php if (( $this->_tpl_vars['event']['is_map'] && $this->_tpl_vars['config']->mapProvider && ( is_numeric ( $this->_tpl_vars['location']['address']['1']['geo_code_1'] ) || ( $this->_tpl_vars['location']['address']['1']['city'] && $this->_tpl_vars['location']['address']['1']['state_province'] ) ) )): ?>
