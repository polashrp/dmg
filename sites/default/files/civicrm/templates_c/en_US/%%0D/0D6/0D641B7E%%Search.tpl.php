<?php /* Smarty version 2.6.27, created on 2017-10-21 03:35:08
...
<div id="searchForm">
    <?php echo '<table class="form-layout"><tr class="crm-event-search-form-block-sort_name"><td class="font-size12pt" colspan="2">'; ?><?php echo $this->_tpl_vars['form']['sort_name']['label']; ?><?php echo '&nbsp;&nbsp;'; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['form']['sort_name']['html'])) ? $this->_run_mod_handler('crmAddClass', true, $_tmp, 'twenty') : smarty_modifier_crmAddClass($_tmp, 'twenty')); ?><?php echo '&nbsp;&nbsp;&nbsp;'; ?><?php echo $this->_tpl_vars['form']['buttons']['html']; ?><?php echo '</td></tr>'; ?><?php if ($this->_tpl_vars['form']['deleted_contacts']): ?><?php echo '<tr class="crm-event-search-form-block-deleted_contacts"><td colspan="2">'; ?><?php echo $this->_tpl_vars['form']['deleted_contacts']['html']; ?><?php echo '&nbsp;&nbsp;'; ?><?php echo $this->_tpl_vars['form']['deleted_contacts']['label']; ?><?php echo '</td></tr>'; ?><?php endif; ?><?php echo ''; ?><?php $_smarty_tpl_vars = $this->_tpl_vars;
