<?php /* Smarty version 2.6.27, created on 2017-10-21 03:21:38
         compiled from CRM/common/SocialNetwork.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/common/SocialNetwork.tpl', 1, false),array('block', 'ts', 'CRM/common/SocialNetwork.tpl', 29, false),array('modifier', 'escape', 'CRM/common/SocialNetwork.tpl', 38, false),array('modifier', 'replace', 'CRM/common/SocialNetwork.tpl', 39, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['title']; ?>
    ...
    <div class="crm-fb-tweet-buttons">
        <?php if ($this->_tpl_vars['emailMode'] == true): ?>
                        <a href="https://twitter.com/share?url=<?php echo ((is_array($_tmp=$this->_tpl_vars['url'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
...
/i/tweet.png" width="55px" height="20px"  alt="Tweet Button">
            ...
            <a href="https://www.facebook.com/plugins/like.php?href=<?php echo $this->_tpl_vars['url']; ?>
" target="_blank">
